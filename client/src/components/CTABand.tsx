  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <FadeInUp>
          <p className="text-[11px] font-semibold tracking-[0.2em] uppercase text-[#d97706] mb-4" style={{ fontFamily: "'Inter', sans-serif" }}>READY TO TALK?</p>
          <h2
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5 max-w-3xl mx-auto leading-tight"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            {heading}
          </h2>
          <p className="text-gray-300 text-base md:text-lg max-w-2xl mx-auto mb-10" style={{ fontFamily: "'Inter', sans-serif" }}>
            {subtext}
          </p>
