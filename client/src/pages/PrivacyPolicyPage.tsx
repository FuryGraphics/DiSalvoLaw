    ...
    <div style={{ backgroundColor: "#000000", minHeight: "100vh" }}>
      ...
      <section className="py-16" style={{ backgroundColor: "#000000" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInUp>
            <div className="prose max-w-none" style={{ fontFamily: "'Inter', sans-serif", color: "#8a8d80", lineHeight: "1.8" }}>
              <p className="text-[#8a8d80] text-sm mb-8">Last updated: January 1, 2025</p>

              <h2 className="text-[#b4b8a8] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>1. Information We Collect</h2>
              ...
              <h2 className="text-[#b4b8a8] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>2. How We Use Your Information</h2>
              ...
              <h2 className="text-[#b4b8a8] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>3. Attorney-Client Privilege</h2>
              ...
              <h2 className="text-[#b4b8a8] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>4. Cookies and Analytics</h2>
              ...
              <h2 className="text-[#b4b8a8] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>5. Data Security</h2>
              ...
              <h2 className="text-[#b4b8a8] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>6. Third-Party Links</h2>
              ...
              <h2 className="text-[#b4b8a8] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>7. Contact Us</h2>
