        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <FadeInUp>
                <p className="text-gray-700 text-base leading-relaxed mb-4" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="py-16" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInUp>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#1e2a3a] mb-10 max-w-2xl leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>All Criminal Defense Services</h2>
          </FadeInUp>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {ADDITIONAL_PRACTICE_AREAS.map((area, i) => (
              <FadeInUp key={area.anchor} delay={(PRACTICE_AREAS.length + i) * 0.07}>
                <div id={area.anchor} className="p-6 h-full shadow-sm" style={{ backgroundColor: "#faf8f5", border: "1px solid #e5e0d8" }}>
                  <h3 className="text-[#1e2a3a] font-bold text-base mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>{area.title}</h3>
                  <p className="text-gray-600 text-xs leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
