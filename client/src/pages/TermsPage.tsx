    ...
    <div style={{ backgroundColor: "#faf8f5", minHeight: "100vh" }}>
      ...
      <section className="py-16" style={{ backgroundColor: "#faf8f5" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInUp>
            <div style={{ fontFamily: "'Inter', sans-serif", color: "#4b5563", lineHeight: "1.8" }}>
              <p className="text-gray-500 text-sm mb-8">Last updated: January 1, 2025</p>

              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>1. Acceptance of Terms</h2>
              ...
              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>2. No Attorney-Client Relationship</h2>
              ...
              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>3. No Legal Advice</h2>
              ...
              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>4. Past Results</h2>
              ...
              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>5. Intellectual Property</h2>
              ...
              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>6. Limitation of Liability</h2>
              ...
              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>7. Governing Law</h2>
              ...
              <h2 className="text-[#1e2a3a] text-xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>8. Contact Information</h2>
